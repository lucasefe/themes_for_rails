...
Configure your app like this, and in load time themes_for_rails will add all your theme's stylesheets path to Sass, so Sass knows how to compile your sass files. 
...
KillerApp::Application.configure do
  ...
  config.themes_for_rails.use_sass = true
